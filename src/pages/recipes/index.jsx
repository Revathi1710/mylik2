...
import UntitledDesign from "../../assets/images/recipes/Untitled-design.png";
  ...
  return (
    <div className="recipes_main_wrapper">
      ...
      <div className="header">
        ...
        <div style={{ paddingTop: "30px" }} className="sub-head">
          <BackgroundHeader
            heading={
              <p className="sub-head-title">
                <span style={{ color: "rgb(249, 147, 27)" }}>Cooking </span>
                Formulas
                {""}
              </p>
            }
